...
export default class GooglePlacesAutocomplete extends Component {
  ...
  getGeocodeAsync = async (location) => {
    ...
    let vitri = geocodec[0].name + ", " + geocodec[0].street + ", " + geocodec[0].city+ ", " + geocodec[0].region + ", " + geocodec[0].country
    console.log(vitri);
    ...
    navigator.geolocation.getCurrentPosition(
      (position) => {
        if (this.props.nearbyPlacesAPI === "None") {
          ...
          // console.log("adsbaksf" + position.coords);

          // this.setState({
          //   coordinates: this.state.coordinates.splice(2, 1),
          // });
          // this.setState({
        ...
        if (request.status === 200) {
          ...
          if (responseJSON.status === "OK") {
            if (this._isMounted === true) {
              ...
              // console.log(details.structured_formatting);
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <View style={{ zIndex: 2, backgroundColor: "#fff" }}>
          {this._getFlatList()}
          {this.props.children}
        </View>
        {/* <View style={{zIndex: 1}}>{this._direction()}</View> */}
      </View>
    );
  }
}
